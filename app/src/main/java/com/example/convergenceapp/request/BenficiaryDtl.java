...
public class BenficiaryDtl {
    ...
    public String getMob_no_belongs_to() {
        return mob_no_belongs_to;
    }

    public void setMob_no_belongs_to(String mob_no_belongs_to) {
        this.mob_no_belongs_to = mob_no_belongs_to;
    }
