  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(7) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        ...
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '415580b81cbd9a7b06b0ffc1d7596393')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        final HashMap<String, TableInfo.Column> _columnsNrlmInfoEntity = new HashMap<String, TableInfo.Column>(26);
        ...
        _columnsNrlmInfoEntity.put("mem_flag", new TableInfo.Column("mem_flag", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        final HashMap<String, TableInfo.Column> _columnsPmaygInfoEntity = new HashMap<String, TableInfo.Column>(25);
        ...
        _columnsPmaygInfoEntity.put("nrlm_village_code", new TableInfo.Column("nrlm_village_code", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
    ...
    }, "415580b81cbd9a7b06b0ffc1d7596393", "fd3ed3b165d863e0bf1885dadfb3eb78");
